...
for(i in 1:length(read_id_7)){
  
  print(paste0(i, ": ", read_id_7[i]))
  
  file.copy(from = paste0("fastas_individuales_2D_pass/",read_id_7[i],".fasta"), to=paste0("2D_pass_7/", read_id_7[i], ".fasta"))
}
